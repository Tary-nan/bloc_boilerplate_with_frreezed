...
class _$AuthenticationEventTearOff {
  ...
  _StatusChanged statusChanged(AuthenticationStatus status) {
...
abstract class _StatusChanged implements AuthenticationEvent {
  factory _StatusChanged(AuthenticationStatus status) = _$_StatusChanged;
...
abstract class _LogoutRequested implements AuthenticationEvent {
  factory _LogoutRequested() = _$_LogoutRequested;
}
